...
const createSendToken = (user, statusCode, req, res) => {
  ...
  res.cookie('jwt', token, {
    ...
    httpOnly: true,
    // x-formwarded is a heroku thing
...
exports.login = catchAsync(async (req, res, next) => {
  ...
  // Call the method define in userModel to check password validitiy
...
exports.protect = catchAsync(async (req, res, next) => {
  ...
  // If code gets here, we go to the next (protected) route
  // Pass on user object to the next middle to be used
...
exports.restrictTo = (...roles) => {
  return (req, res, next) => {
    ...
    // get user object from previous middleware
...
exports.resetPassword = catchAsync(async (req, res, next) => {
  ...
  const hashedToken = crypto
    .createHash('sha256')
    // Get token provided in params in resetPassword/:token
