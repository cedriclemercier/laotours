...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiY2VkcmljbGVtZXJjaWVyIiwiYSI6ImNrYWYxc205YzBiMTcydG12N214cmU1bWMifQ.YGqGj3nSIlRD0aMhuBGx3g';
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); // Extends the map bounds to include all locations
...
var stripe = Stripe("pk_test_MSjynKpmafIB5SMzbPmo2XaV00cdYJoLzo");
